                    ...
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('admin/body-types*') ? ' active' : '' }}"
                                ...
                                <i class="nav-main-link-icon si si-cursor"></i>
                                <span class="nav-main-link-name">Body Types</span>
                            </a>
                        </li>

                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('admin/vehicle-types*') ? ' active' : '' }}"
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('admin/drive-types*') ? ' active' : '' }}"
                                href="{{ route('admin.drive-types.index') }}">
                                <i class="nav-main-link-icon si si-cursor"></i>
                                <span class="nav-main-link-name">Drive Types</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('admin/news*') ? ' active' : '' }}"
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('admin/reviews*') ? ' active' : '' }}"
