...
@php
    $addEdit = isset($feature) ? 'Edit' : 'Add';
    $addUpdate = isset($feature) ? 'Update' : 'Add';
@endphp
    ...
    <div class="content content-boxed">
        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default d-flex">
                <h3 class="block-title">{{ $addEdit }} Feature</h3>

                <a href="{{ route('admin.features.index') }}" class="btn btn-primary">Back</a>
                    ...
                    <div class="col-lg-12 ">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <?php
                                $value = old('name', $feature ? $feature->name : null);
