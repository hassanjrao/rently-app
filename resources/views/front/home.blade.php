                                        ...
                                        <div class="de_form de_radio row g-3">
                                            ...
                                            <div class="radio-img col-lg-3 col-sm-3 col-6">
                                                ...
                                                <label for="radio-1b"><img
                                                        src="{{ asset('front-assets/images/select-form/van.png') }}"
                                                        alt="">Van</label>
                                            </div>
                                            ...
                                            <div class="radio-img col-lg-3 col-sm-3 col-6">
                                                ...
                                                <label for="radio-1c"><img
                                                        src="{{ asset('front-assets/images/select-form/minibus.png') }}"
                                                        alt="">Minibus</label>
                                            </div>
                                            ...
                                            <div class="radio-img col-lg-3 col-sm-3 col-6">
                                                ...
                                                <label for="radio-1d"><img
                                                        src="{{ asset('front-assets/images/select-form/sportscar.png') }}"
                                                        alt="">Prestige</label>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="bloglist s2 item">
                            <div class="post-content">
                                <div class="post-image">
                                    ...
                                    <img alt="" src="{{ asset('front-assets/images/news/pic-blog-1.jpg') }}"
                                        class="lazy">
                                </div>
                                <div class="post-text">
                        ...
                        <div class="bloglist s2 item">
                            <div class="post-content">
                                <div class="post-image">
                                    ...
                                    <img alt="" src="{{ asset('front-assets/images/news/pic-blog-2.jpg') }}"
                                        class="lazy">
                                </div>
                                <div class="post-text">
                        ...
                        <div class="bloglist s2 item">
                            <div class="post-content">
                                <div class="post-image">
                                    ...
                                    <img alt="" src="{{ asset('front-assets/images/news/pic-blog-3.jpg') }}"
                                        class="lazy">
                                </div>
                                <div class="post-text">
                                    <h4><a href="news-single.html">Holiday Tips For Backpacker<span></span></a>
                                    </h4>
                                    <p>Dolore officia sint incididunt non excepteur ea mollit commodo ut enim
                                        reprehenderit cupidatat labore ad laborum consectetur.</p>
                                    <a class="btn-main" href="#">Read More</a>
